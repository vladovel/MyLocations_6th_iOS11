...
//
//  Created by Vlado Velkovski on 2/28/18.
...
class MapViewController: UIViewController {
    ...
    func region(for annotations: [MKAnnotation]) -> MKCoordinateRegion {
        ...
        default:
            ...
            let span = MKCoordinateSpan(latitudeDelta: abs(topLeft.latitude - bottomRight.latitude) * extraSpace, longitudeDelta: abs(topLeft.longitude - bottomRight.longitude) * 1.1)
